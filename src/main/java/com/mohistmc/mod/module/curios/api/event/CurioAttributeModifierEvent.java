...
package com.mohistmc.mod.module.curios.api.event;
...
import com.mohistmc.mod.module.curios.api.common.slot.SlotTypePredicate;
 ...
 * {@link com.mohistmc.mod.module.curios.api.type.capability.ICurioItem#getAttributeModifiers(ItemStack)}.
 *
 * <p>This event is fired regardless of if the stack has
 * {@link com.mohistmc.mod.module.curios.api.CuriosDataComponents#ATTRIBUTE_MODIFIERS} or not. If your
...
public class CurioAttributeModifierEvent extends Event {
     ...
     * {@link com.mohistmc.mod.module.curios.api.SlotAttribute#getOrCreate(String)} to obtain an instance of
    ...
    private static class CurioAttributeModifiersBuilder {
        ...
        private final Map<Key, CurioAttributeModifiers.Entry>
                entriesByKey;
        ...
        CurioAttributeModifiersBuilder(CurioAttributeModifiers defaultModifiers) {
            ...
            for (CurioAttributeModifiers.Entry entry : defaultModifiers.modifiers()) {
                ...
                this.entriesByKey.put(
                        new Key(entry.attributeHolder(), entry.modifier().id()),
                        entry);
            }
        }
        ...
        boolean removeModifier(Holder<Attribute> attribute, Identifier id) {
            CurioAttributeModifiers.Entry entry =
                    this.entriesByKey.remove(new Key(attribute, id));
        ...
        CurioAttributeModifiers.Entry replaceModifier(Holder<Attribute> attribute,
                                                      ...
                                                      SlotTypePredicate slotTypePredicate) {
            Key
                    key = new Key(attribute, modifier.id());
            CurioAttributeModifiers.Entry entry =
                    new CurioAttributeModifiers.Entry(attribute, modifier, slotTypePredicate);

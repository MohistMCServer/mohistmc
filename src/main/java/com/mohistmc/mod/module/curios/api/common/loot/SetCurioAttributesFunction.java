...
package com.mohistmc.mod.module.curios.api.common.loot;
...
public class SetCurioAttributesFunction extends LootItemConditionalFunction {
                ...
                RecordCodecBuilder.create(
                        modifier -> modifier.group(
                                        ...
                                        SlotTypePredicate.FULL_CODEC
                                                ...
                                                .forGetter(Modifier::slotTypePredicate)
                                )
                                .apply(modifier, Modifier::new)
                );
    }
    ...
    public static class ModifierBuilder {
         ...
         */
        public ModifierBuilder forSlotId(String... id) {
         ...
         * @see SlotTypePredicate
         */
        public ModifierBuilder forSlot(ISlotType... slotType) {
         ...
         * @return This builder instance.
         */
        public ModifierBuilder forSlot(
                SlotTypePredicate... slotTypePredicate) {
        ...
        public Modifier build() {
            return new Modifier(this.id, this.attribute, this.operation,

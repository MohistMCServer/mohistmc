...
public record SlotTypePredicate(List<String> id,
    ...
    public static class Builder {
         ...
         */
        public Builder withId(String... slots) {
         ...
         * @return This builder instance.
         */
        public Builder withSize(MinMaxBounds.Ints size) {
            this.size = size;
            return this;
        }
         ...
         * @return This builder instance.
         */
        public Builder hasCosmetic(boolean flag) {
         ...
         * @return This builder instance.
         */
        public Builder canToggleRendering(boolean flag) {

...
public abstract class CurioChangeEvent extends LivingEvent {
    ...
    /**
     * {@link Item} is fired when the curio change is due to a difference in items
    ...
    public static class Item extends CurioChangeEvent {
         ...
         * @param from   The previous {@link ItemStack}.
         * @param to     The current/new {@link ItemStack}.
         * @see Item#Item(LivingEntity, SlotContext, ItemStack, ItemStack)
    ...
    /**
     * {@link State} is fired when the curio change is due to a difference in count
    ...
    public static class State extends CurioChangeEvent {
         ...
         * @param from   The previous {@link ItemStack}.
         * @param to     The current/new {@link ItemStack}.
         * @see State#State(LivingEntity, SlotContext, ItemStack, ItemStack)

...
import com.mohistmc.mod.module.farmersdelight.common.item.component.consumable.ExtinguishConsumeEffect;
import com.mohistmc.mod.module.farmersdelight.common.item.component.consumable.HealConsumeEffect;
import com.mohistmc.mod.module.farmersdelight.common.item.component.consumable.RemoveRandomStatusEffectsConsumeEffect;
...
public class FoodValues
{
	...
	public static final FoodProperties COD_ROLL = (new FoodProperties.Builder())
		.nutrition(7).saturationModifier(0.6f).build();
	public static final FoodProperties KELP_ROLL = new FoodProperties(12, 12, false);
	...
	{
		/**
		 * Same as {@link Consumables#DRIED_KELP
		 */
		...
		/**
		 * Same as {@link Consumables#CHICKEN
		 */
		...
		public static final Consumable NOURISHMENT_BRIEF_DURATION = Consumables.defaultFood()
			.onConsume(new ApplyStatusEffectsConsumeEffect(nourishment(BRIEF_DURATION)))
			.build();
		public static final Consumable NOURISHMENT_SHORT_DURATION = Consumables.defaultFood()
			.onConsume(new ApplyStatusEffectsConsumeEffect(nourishment(SHORT_DURATION)))
			.build();
		public static final Consumable NOURISHMENT_MEDIUM_DURATION = Consumables.defaultFood()
			.onConsume(new ApplyStatusEffectsConsumeEffect(nourishment(MEDIUM_DURATION)))
			.build();
		public static final Consumable NOURISHMENT_LONG_DURATION = Consumables.defaultFood()
			.onConsume(new ApplyStatusEffectsConsumeEffect(nourishment(LONG_DURATION)))
			.build();
		...
		public static final Consumable HOT_COCOA = Consumables.defaultDrink()
			.onConsume(new RemoveRandomStatusEffectsConsumeEffect(ModTags.MobEffects.HOT_COCOA_IGNORED, true))
			.build();
		public static final Consumable MILK_BOTTLE = Consumables.defaultDrink()
			.onConsume(new RemoveRandomStatusEffectsConsumeEffect(ModTags.MobEffects.MILK_BOTTLE_IGNORED))
			.build();
		...
		public static final Consumable CHICKEN_CUTS = Consumables.defaultFood()
			...
			.onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.3F))
			.build();
		public static final Consumable GLOW_BERRY_CUSTARD = Consumables.defaultDrink()
			.onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.GLOWING, 100, 0)))
			.build();
		public static final Consumable FRUIT_SALAD = Consumables.defaultFood()
		...
		public static final Consumable MIXED_SALAD = Consumables.defaultFood()
			.onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.REGENERATION, 100, 0), 1.0F))
			.build();
		public static final Consumable KELP_ROLL = Consumables.defaultFood()
			.consumeSeconds(2.4F)
			.build();

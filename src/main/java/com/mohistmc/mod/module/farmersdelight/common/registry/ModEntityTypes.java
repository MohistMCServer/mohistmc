...
public class ModEntityTypes
{
	...
	public static final Supplier<EntityType<RottenTomatoEntity>> ROTTEN_TOMATO = ENTITIES.register("rotten_tomato", () -> (
		EntityType.Builder.<RottenTomatoEntity>of(RottenTomatoEntity::new, MobCategory.MISC)
			...
			.updateInterval(10)
			.build(FDKey("rotten_tomato"))));

	public static ResourceKey<EntityType<?>> FDKey(String name) {
		return ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, name));
	}
}

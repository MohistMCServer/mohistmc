...
public class Configuration
{
	...
	static {
		...
		ENABLE_TOMATO_VINE_CLIMBING_TAGGED_ROPES = COMMON_BUILDER.comment("If enabled, tomato crops will be able to climb any rope tagged as mohistmc:ropes. If disabled, this will be restricted to this mod's rope only.")
		...
		DEFAULT_TOMATO_VINE_ROPE = COMMON_BUILDER.comment("Which rope should Tomato Vines leave behind when broken?")
			.define("defaultTomatoVineRope", "mohistmc:rope");
		COMMON_BUILDER.pop();

...
import com.mohistmc.mod.module.create.content.kinetics.chainConveyor.ChainConveyorBlockEntity.ConnectedPort;
...
public abstract class PackagePortTarget {
    ...
    public static final StreamCodec<? super RegistryFriendlyByteBuf, PackagePortTarget> PACKET_CODEC = CatnipStreamCodecBuilders.registryEntry(

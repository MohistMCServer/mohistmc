...
import com.mohistmc.mod.module.create.client.AllTrackMaterialModels.TrackModelHolder;
    ...
    public void extractRenderState(
        ...
        for (BezierConnection bc : be.getConnections().values()) {
            ...
            if (length != 0) {
                ...
                TrackSegmentRenderState.TrackSegmentBuffers buffers = track.getBuffers(bc.getMaterial());
                for (int i = 0; i < length; i++) {
                    track.add(
                        buffers,
                        LightCoordsUtil.getLightCoords(level, segment.lightPosition[i].offset(bePosition)),

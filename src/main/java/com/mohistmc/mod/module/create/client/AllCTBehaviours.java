...
import com.mohistmc.mod.module.create.client.content.contraptions.chassis.ChassisCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.MetalScaffoldingCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.RoofBlockCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.TrapdoorCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.encasing.EncasedCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.girder.GirderCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.palettes.CTs;
import com.mohistmc.mod.module.create.client.content.decoration.palettes.WeatheredIronWindowCTBehaviour;
import com.mohistmc.mod.module.create.client.content.decoration.palettes.WeatheredIronWindowPaneCTBehaviour;
import com.mohistmc.mod.module.create.client.content.fluids.tank.FluidTankCTBehaviour;
import com.mohistmc.mod.module.create.client.content.kinetics.crafter.CrafterCTBehaviour;
import com.mohistmc.mod.module.create.client.content.kinetics.simpleRelays.encased.EncasedCogCTBehaviour;
import com.mohistmc.mod.module.create.client.content.logistics.tunnel.BrassTunnelCTBehaviour;
import com.mohistmc.mod.module.create.client.content.logistics.vault.ItemVaultCTBehaviour;
import com.mohistmc.mod.module.create.client.foundation.block.connected.GlassPaneCTBehaviour;
import com.mohistmc.mod.module.create.client.foundation.block.connected.HorizontalCTBehaviour;
import com.mohistmc.mod.module.create.client.foundation.block.connected.RotatedPillarCTBehaviour;
import com.mohistmc.mod.module.create.client.foundation.block.connected.SimpleCTBehaviour;

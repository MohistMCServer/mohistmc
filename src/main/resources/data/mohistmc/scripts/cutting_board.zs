...
An important thing to note is that if you are passing in a sound parameter, which is Optional, you need to specify the FULL Identifier:
...
<recipetype:mohistmc:cutting>.addRecipe("cutting_board_test", <item:minecraft:gravel>, [<item:minecraft:flint>], <item:minecraft:string>, "minecraft:block.gravel.break");

<recipetype:mohistmc:cutting>.addRecipe("tool_action_example", <item:minecraft:jack_o_lantern>, [<item:minecraft:torch>, <item:mohistmc:pumpkin_slice> * 3 % 60], <toolaction:shears_carve>, "block.pumpkin.carve");

<recipetype:mohistmc:cutting>.addRecipe("wool_to_string", <tag:items:minecraft:wool>, [(<item:minecraft:string> * 2) % 50], <item:minecraft:shears>);

<recipetype:mohistmc:cutting>.remove(<item:minecraft:leather>);
